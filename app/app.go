...
import (
	...
	bcmodule "bc/x/bc"
	bcmodulekeeper "bc/x/bc/keeper"
	bcmoduletypes "bc/x/bc/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "bc/app/params"
	"bc/docs"
)
...
type App struct {
	*baseapp.BaseApp
	...
	BcKeeper bcmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.BcKeeper = *bcmodulekeeper.NewKeeper(
		appCodec,
		keys[bcmoduletypes.StoreKey],
		keys[bcmoduletypes.MemStoreKey],
		app.GetSubspace(bcmoduletypes.ModuleName),
	)
	bcModule := bcmodule.NewAppModule(appCodec, app.BcKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(bcmoduletypes.ModuleName)
